...
/**
 * Generates thumbnail of an img with width size.
 * @param {String} filePat, location of the original file.
...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Welcome to ALX-Files_Manager Harzjunior';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/harzjunior/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/harzjunior">Haruna Bah Jibril</a>. ',

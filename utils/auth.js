...
/**
 * Fetches the user from the Auth header in the given req obj
...
/**
 * Fetches the user from the X-Token header in the given req obj
 * @param {Request} req The Express request obj
 * @returns {Promise<{_id: ObjectId, email: string, password: string}>}
 */
